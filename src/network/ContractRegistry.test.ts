...
describe('ContractRegistry', () => {
  ...
  describe('getSafeContractAddress', () => {
    ...
    it('should throw error for unsupported network', () => {
      expect(() => registry.getSafeContractAddress('eip155:999')).toThrow(
  ...
  describe('getProxyFactoryAddress', () => {
    ...
    it('should throw error for unsupported network', () => {
      expect(() => registry.getProxyFactoryAddress('eip155:999')).toThrow(
        'Network eip155:999 is not supported'
      );
    });
  });
  ...
  describe('predictSafeAddress', () => {
    it('should predict CREATE2 address for Safe deployment', () => {
      ...
      const predictedAddress = registry.predictSafeAddress(
        'eip155:1',
        owners,
        threshold,
        salt
    ...
    it('should return different addresses for different parameters', () => {
      ...
      const address1 = registry.predictSafeAddress(
        'eip155:1',
        owners1,
        threshold,
        salt
      );
      const address2 = registry.predictSafeAddress(
        'eip155:1',
        owners2,
        threshold,
        salt
    ...
    it('should throw error for unsupported network', () => {
      ...
      expect(() =>
        registry.predictSafeAddress('eip155:999', owners, threshold, salt)
      ).toThrow('Network eip155:999 is not supported');
    });
  });
  ...
  describe('getContractABI', () => {
    ...
    it('should throw error for unknown contract', () => {
      expect(() => registry.getContractABI('UnknownContract')).toThrow(
        'Unknown contract: UnknownContract'
      );
    });
  });
  ...
  describe('getNetworkInfo', () => {
    ...
    it('should throw error for unsupported network', () => {
      expect(() => registry.getNetworkInfo('eip155:999')).toThrow(
        'Network eip155:999 is not supported'
      );
    });
  });
