...
describe('SafeError', () => {
    ...
    it('should create error with details', () => {
        ...
        const error = new SafeError('Network failed', ErrorCodes.NETWORK_ERROR, details);
        expect(error.details).toEqual(details);
    });
    it('should convert to JSON format', () => {
        const error = new SafeError('Validation failed', ErrorCodes.VALIDATION_ERROR, { field: 'address' });
