...
describe('ConfigValidator', () => {
    ...
    describe('validateEthereumAddress', () => {
        it('should validate correct Ethereum addresses', () => {
            expect(validator.validateEthereumAddress('0x742d35Cc6634C0532925a3b8D46dE3C4df6Eb2fa')).toBe(true);
            expect(validator.validateEthereumAddress('0x0000000000000000000000000000000000000000')).toBe(true);
        });
        it('should reject invalid Ethereum addresses', () => {
            expect(validator.validateEthereumAddress('0x123')).toBe(false);
            expect(validator.validateEthereumAddress('123')).toBe(false);
            expect(validator.validateEthereumAddress('0x742d35Cc6634C0532925a3b8D46dE3C4df6Eb2fag')).toBe(false);
