...
describe('NetworkProviderManager', () => {
    ...
    describe('getProvider', () => {
        it('should create and return ethers provider for valid network', async () => {
            ...
            expect(provider._getConnection().url).toBe('https://eth.example.com');
        });
        it('should throw error for unsupported network', async () => {
            await expect(manager.getProvider('eip155:999')).rejects.toThrow('Network eip155:999 is not configured');
        });
        ...
        it('should apply runtime configuration overrides', async () => {
            ...
            expect(provider._getConnection().url).toBe('https://custom.example.com');
    ...
    describe('failover handling', () => {
        it('should handle provider configuration with invalid URLs', async () => {
            ...
            const managerWithFailover = new NetworkProviderManager(configWithFailover);
